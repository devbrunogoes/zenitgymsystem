...
@WebServlet(name="ListarEventoCalPers", urlPatterns={"/ListarEventoCalPers"})
public class ListarEventoCalPers extends HttpServlet {
    ...
    throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
          ...
          try {
            ...
            List<Aula> aulas = aulaDAO.listarAulasPorPersonal(codPers);
            List<Analise> analises = analiseDAO.listarAnalisesPorPersonal(codPers);
            ...
            for (Analise analise : analises) {
                if (analise.getDtAgendamentoAv() != null && analise.getHrAgendamentoAv() != null) {
                    ...
                    evento.put("title", "Analise - " + analise.getObjetivoAv());
